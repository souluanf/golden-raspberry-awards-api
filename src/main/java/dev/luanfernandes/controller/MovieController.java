...
public interface MovieController {
    ...
    @Operation(
            summary = "Get producers with award intervals",
            tags = {"movie"},
            responses = {
    ...
    @GetMapping(PRODUCERS_AWARD_INTERVALS)
    ResponseEntity<ProducerAwardIntervalResponse> getProducersWithAwardIntervals();
}
