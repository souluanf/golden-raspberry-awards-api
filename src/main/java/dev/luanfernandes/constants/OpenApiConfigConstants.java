...
public class OpenApiConfigConstants {
    public static final String OPENAPI_INFO_TITLE = "Caci API";
    public static final String OPENAPI_INFO_VERSION = "0.0.1";
    public static final String OPENAPI_INFO_DESCRIPTION = "API for Caci project";
    ...
    public static final String OPENAPI_EXTERNAL_DOCS_URL = "https://github.com/caci-ong/caci-api";
}
